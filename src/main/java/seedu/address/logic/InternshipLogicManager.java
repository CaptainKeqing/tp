 ...
 */
public class InternshipLogicManager implements Logic {
    ...
    private final InternshipDataStorage storage;
    private final InternshipDataParser internshipDataParser;

    /**
     * Constructs a {@code InternshipLogicManager} with the
     * given {@code InternshipModel} and {@code InternshipDataStorage}.
     */
    public InternshipLogicManager(InternshipModel model, InternshipDataStorage storage) {
        this.model = model;
    ...
    public CommandResult execute(String commandText) throws CommandException, ParseException {
        ...
        Command command = internshipDataParser.parseCommand(commandText);
